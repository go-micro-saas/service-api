...
func (s *grpcAPI) GetAndAutoRenewalNodeID(ctx context.Context, req *nodeidresourcev1.GetNodeIdReq) (*nodeidresourcev1.GetNodeIdRespData, error) {
...
func (s *grpcAPI) RenewalNodeID(ctx context.Context, dataModel *nodeidresourcev1.GetNodeIdRespData) error {
	// token错误：ID被其他程序占用
	var (
